...
const Women = () => {
  ...
  const { GetAllProductWomen, AddProductLike, DeleteProductLike } = useActions();
            ...
            <div className="col-10">
                  ...
                  <div className="col-1">
                    <div className="productCountPage">
                      ...
                      <div className="prodcuttotalItems">
                        <p>{productsWoman.length} items</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="itemsProducts">
                <div className="rowItemsProducts">
                  ...
                  </div> : productsWoman.length == 0 ? null : (<ul>{dataProduct}</ul>)}
                </div>
              </div>
              {loadingProductMan == true || productsWoman.length == 0 ? null : <div className="moreProduct"><button onClick={() => { MoreCountProdcutShow(); }} className="btn">load more</button></div>}
