...
import './product.css';
import '../ManAndWomanPage/style.css'
...
const ProductPageWoman = () => {
    ...
    const [pro, showPro] = useState();
    const {AddProductLike, DeleteProductLike } = useActions();
    ...
    const clrs = productCurrent.color.map((item) => {
            return(
            <div className='square' style={{backgroundColor:item}} />)
        })
    ...
    const desc = productCurrent.description.split('.').map((item) =>{
        return(
    ...
    const prod = Might_like().map((item:any)=>{
        return(
    ...
    function Arrow(){return( <button style={{backgroundColor:'white', border:'none', width:"30px"}}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" style={{margin: '10px 0 10px 0'}}><path d="M16.2468 6.65752L9.9993 12.7475L3.7518 6.65752C3.64018 6.54849 3.49034 6.48746 3.3343 6.48746C3.17827 6.48746 3.02842 6.54849 2.9168 6.65752C2.86275 6.71048 2.81982 6.77368 2.7905 6.84344C2.76119 6.9132 2.74609 6.98811 2.74609 7.06377C2.74609 7.13944 2.76119 7.21434 2.7905 7.2841C2.81982 7.35386 2.86275 7.41707 2.9168 7.47002L9.56305 13.95C9.67977 14.0638 9.83631 14.1275 9.9993 14.1275C10.1623 14.1275 10.3188 14.0638 10.4356 13.95L17.0818 7.47127C17.1362 7.41828 17.1795 7.35491 17.209 7.28493C17.2386 7.21494 17.2538 7.13974 17.2538 7.06377C17.2538 6.9878 17.2386 6.91261 17.209 6.84262C17.1795 6.77263 17.1362 6.70927 17.0818 6.65627C16.9702 6.54724 16.8203 6.48621 16.6643 6.48621C16.5083 6.48621 16.3584 6.54724 16.2468 6.65627V6.65752Z" fill="#353535"/></svg></button>)}          
    function Reversed(){return(<button style={{backgroundColor:'white', border:'none', width:"30px"}}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M16.2468 13.9561L9.9993 7.8661L3.7518 13.9561C3.64018 14.0651 3.49034 14.1262 3.3343 14.1262C3.17827 14.1262 3.02842 14.0651 2.9168 13.9561C2.86275 13.9031 2.81982 13.8399 2.7905 13.7702C2.76119 13.7004 2.74609 13.6255 2.74609 13.5499C2.74609 13.4742 2.76119 13.3993 2.7905 13.3295C2.81982 13.2598 2.86275 13.1966 2.9168 13.1436L9.56305 6.6636C9.67977 6.54984 9.83631 6.48616 9.9993 6.48616C10.1623 6.48616 10.3188 6.54984 10.4356 6.6636L17.0818 13.1424C17.1362 13.1953 17.1795 13.2587 17.209 13.3287C17.2386 13.3987 17.2538 13.4739 17.2538 13.5499C17.2538 13.6258 17.2386 13.701 17.209 13.771C17.1795 13.841 17.1362 13.9044 17.0818 13.9574C16.9702 14.0664 16.8203 14.1274 16.6643 14.1274C16.5083 14.1274 16.3584 14.0664 16.2468 13.9574V13.9561Z" fill="#353535"/></svg></button>)}             
        ...
        if(loading){
            return(
                <>
                <Header_full/>
                <div className="basketLoader prodLoad">
       ...
       <div className='product'>
            ...
            <div className="info">
                <div className="blocke">
                    ...
                    <p className='code'>Product code: {productCurrent.id}</p>
                </div>

                <div className="blocke">
                    <h1 className='price'>{productCurrent.price}$</h1>
                </div>

                <div className="blocke">
                    <p className='code'>Color: {productCurrent.color[0]}</p>
                ...
                <div className="blocke">
                    <ul className='description'>
                        ...
                        <li onClick={() => showBrand(!brand)}>
                            <p>Brand</p>
                            {brand ? <Reversed/> : <Arrow/> }
                        ...
                        <hr/>
                            {brand && (
                                <div id='desc'>
                                <p>
                                    {"Brand: " + productCurrent.brand}
                                </p>
                                </div>
                              )}
                              
                        {/* <li onClick={() => showSize(!siz)}>
                              <p>Size &</p>
                              {arrow}
                          </li>
                          <hr/>
